...
import { Button, Platform, Modal, View, Text, StyleSheet, SafeAreaView } from 'react-native'
			...
			<SafeAreaView style={styles.modalContainer}>
				<View style={{
					...
					<View style={{
						...
						<Button onPress={closeModal} title={'Fechar'} color={Platform.OS === 'ios' ? '#000' : '#c02f0c'} />
					</View >
				</View>
				<View style={{
					flex: 1,
